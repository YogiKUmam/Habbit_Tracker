...
export const StatsOverview: React.FC<StatsOverviewProps> = ({ stats }) => {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
      ...
      {/* 1. Progres Hari Ini */}
      <div className="relative p-4 sm:p-5 rounded-3xl border border-border/80 bg-gradient-to-b from-emerald-500/5 dark:from-emerald-950/20 to-card shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
        ...
        <div className="mt-3 w-full bg-secondary rounded-full h-2 overflow-hidden border border-border/40">
          <div
      ...
      {/* 2. Streak Aktif */}
      <div className="relative p-4 sm:p-5 rounded-3xl border border-border/80 bg-gradient-to-b from-amber-500/5 dark:from-amber-950/20 to-card shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
            Streak Aktif
          </span>
      ...
      {/* 3. Rekor Terbaik */}
      <div className="relative p-4 sm:p-5 rounded-3xl border border-border/80 bg-gradient-to-b from-violet-500/5 dark:from-violet-950/20 to-card shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
            Rekor Terbaik
          </span>
          <div className="p-2.5 rounded-2xl bg-violet-500/10 text-violet-600 dark:text-violet-400 border border-violet-500/20 shadow-xs">
            <Trophy className="h-4 w-4" />
          </div>
        </div>

        <div className="mt-3 flex items-baseline gap-1.5">
          <span className="text-2xl sm:text-3xl font-black tracking-tight text-violet-500 font-mono">
            {stats.bestStreak}
          </span>
      ...
      {/* 4. Total Selesai */}
      <div className="relative p-4 sm:p-5 rounded-3xl border border-border/80 bg-gradient-to-b from-cyan-500/5 dark:from-cyan-950/20 to-card shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
            Total Selesai
          </span>
        ...
        <div className="mt-3 flex items-baseline gap-1.5">
          <span className="text-2xl sm:text-3xl font-black tracking-tight text-cyan-600 dark:text-cyan-400 font-mono">
